export const aboutText = {
  ru: 'Я стремлюсь к постоянному росту и развитию в области fullstack разработки, поэтому я всегда готов к новым вызовам. Мне всегда интересны сложные задачи, преодолевая которые получаю драгоценный опыт и немного удовольствия. С моими работами можно ознакомиться ниже. Здесь представлены только те проекты, которые были завершены и уже выполняют свою функцию. Если вам нужна более подробная информация обо мне, вы можете посмотреть мое ',
  en: 'I strive for constant growth and development in the field of full-stack development, so I am always ready for new challenges. I am always interested in difficult tasks, overcoming which I gain valuable experience and a little pleasure. My works can be found below. Only those projects that have been completed and are already fulfilling their function are presented here. If you want more information about me, you can look at my '
};
